          ...
          <div className="lg:w-2/3 w-full">
            <RevealOnScroll delay={200}>
              ...
              <p className="text-slate-600 dark:text-slate-300 text-lg leading-relaxed mb-12">
                I have over 8 years of experience building high-performance web applications. 
                My journey started with simple static sites and has evolved into architecting complex, 
                cloud-native solutions for startups and enterprises alike. I'm obsessed with clean code, 
