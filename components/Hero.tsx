        ...
        <div className="w-full md:w-2/3 text-center md:text-left">
          <RevealOnScroll>
            ...
            <p className="text-lg md:text-xl text-slate-600 dark:text-slate-400 mb-10 max-w-2xl mx-auto md:mx-0 leading-relaxed">
              I'm Suleiman, a Full-Stack Software Engineer specializing in scalable web applications, 
              AI integration, and cloud architecture. I turn complex problems into elegant interfaces.
            </p>
